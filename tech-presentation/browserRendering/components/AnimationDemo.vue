...
<template>
  ...
  >
    ...
    <div
      ...
      rounded="lg"
      overflow="hidden"
      border="2 gray-300 dark:gray-700"
    >
      ...
      <div
        ...
        :style="{
          ...
          willChange: 'transform',
          background: 'linear-gradient(to bottom right, #ef4444, #be123c)',
        }"
      >
        16ms
      </div>
    ...
    <div class="info" mt="6" text="sm gray-600 dark:gray-300" space-y="2">
      <p flex="~" items="center" gap="2">
        <span w="4" h="4" rounded="sm" style="background: #3b82f6"></span>
        <strong>藍色方塊（rAF）：</strong> 使用
        <code bg="gray-200 dark:gray-600" px="1" rounded
          >requestAnimationFrame</code
        >
        驅動動畫
      </p>
      <p flex="~" items="center" gap="2">
        <span w="4" h="4" rounded="sm" style="background: #ef4444"></span>
        <strong>紅色方塊（16ms）：</strong> 使用
        <code bg="gray-200 dark:gray-600" px="1" rounded
          >setInterval(16.67ms)</code
        >
        驅動動畫
      </p>
      <p>
        <strong>比較：</strong> 仔細觀察兩個方塊的流暢度差異，rAF
        會與瀏覽器重繪同步，傳統方法可能出現掉幀或不流暢
      </p>
    </div>
  </div>
</template>
